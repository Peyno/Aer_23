...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_INST_m3_DEF_CAN_FIRE_RL_justonce;
	 tUInt8 DEF_INST_top_INST_m3_DEF_WILL_FIRE_RL_justonce;
	 DEF_INST_top_INST_m3_DEF_CAN_FIRE_RL_justonce = (tUInt8)1u;
	 DEF_INST_top_INST_m3_DEF_WILL_FIRE_RL_justonce = DEF_INST_top_INST_m3_DEF_CAN_FIRE_RL_justonce;
	 if (DEF_INST_top_INST_m3_DEF_WILL_FIRE_RL_justonce)
	   INST_top.INST_m3.RL_justonce();
	 if (do_reset_ticks(simHdl))
	 {
	   INST_top.INST_m3.INST_m1b.INST_x.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_m3.INST_m2.INST_m1a.INST_x.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_m3.INST_m2.INST_x.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_m3.INST_x.rst_tick__clk__1((tUInt8)1u);
	 }
       };
...
void MODEL_mkTb::create_model(tSimStateHdl simHdl, bool master)
{
  ...
  (mkTb_instance->INST_m3.INST_m1b.set_clk_0)("CLK");
  (mkTb_instance->INST_m3.INST_m2.INST_m1a.set_clk_0)("CLK");
  (mkTb_instance->INST_m3.INST_m2.set_clk_0)("CLK");
  (mkTb_instance->INST_m3.set_clk_0)("CLK");
...
time_t MODEL_mkTb::get_creation_time()
{
  ...
  /* Tue Dec 26 19:47:09 UTC 2023 */
  return 1703620029llu;
}
