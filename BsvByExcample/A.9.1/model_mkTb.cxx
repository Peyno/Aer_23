...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_inint;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_inint;
	 ...
	 INST_top.DEF_b__h141 = INST_top.INST_step.METH_read();
	 DEF_INST_top_DEF_CAN_FIRE_RL_inint = (INST_top.DEF_b__h141) == 0u;
	 DEF_INST_top_DEF_WILL_FIRE_RL_inint = DEF_INST_top_DEF_CAN_FIRE_RL_inint;
	 DEF_INST_top_DEF_CAN_FIRE_RL_step1 = (INST_top.DEF_b__h141) == 1u;
	 DEF_INST_top_DEF_WILL_FIRE_RL_step1 = DEF_INST_top_DEF_CAN_FIRE_RL_step1;
	 DEF_INST_top_DEF_CAN_FIRE_RL_step2 = (INST_top.DEF_b__h141) == 2u;
	 DEF_INST_top_DEF_WILL_FIRE_RL_step2 = DEF_INST_top_DEF_CAN_FIRE_RL_step2;
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_inint)
	   INST_top.RL_inint();
	 ...
	 if (do_reset_ticks(simHdl))
	 {
	   ...
	   INST_top.INST_r2.rst_tick__clk__1((tUInt8)1u);
	 }
       };
...
time_t MODEL_mkTb::get_creation_time()
{
  ...
  /* Wed Jan 10 13:15:04 UTC 2024 */
  return 1704892504llu;
}
