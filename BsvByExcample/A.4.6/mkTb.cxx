...
/* String declarations */
static std::string const __str_literal_1("      y = %0h", 13u);
...
{
  tUInt32 DEF_x_PLUS_0x10___d3;
  tUInt32 DEF_b__h137;
  DEF_b__h137 = INST_x.METH_read();
  DEF_x_PLUS_0x10___d3 = DEF_b__h137 + 16u;
  INST_pipe.METH_send(DEF_b__h137);
  INST_x.METH_write(DEF_x_PLUS_0x10___d3);
}

void MOD_mkTb::RL_drain()
{
  tUInt8 DEF_NOT_pipe_receive_SLE_0x80___d8;
  tUInt32 DEF_pipe_receive___d5;
  tUInt32 DEF_signed_pipe_receive___d6;
  tUInt32 DEF_AVMeth_pipe_receive;
  DEF_AVMeth_pipe_receive = INST_pipe.METH_receive();
  DEF_pipe_receive___d5 = DEF_AVMeth_pipe_receive;
  DEF_signed_pipe_receive___d6 = DEF_pipe_receive___d5;
  DEF_NOT_pipe_receive_SLE_0x80___d8 = !primSLE8(1u,
						 32u,
						 (tUInt32)(DEF_pipe_receive___d5),
						 32u,
						 128u);
  ...
  {
    dollar_display(sim_hdl, this, "s,-32", &__str_literal_1, DEF_signed_pipe_receive___d6);
    if (DEF_NOT_pipe_receive_SLE_0x80___d8)
