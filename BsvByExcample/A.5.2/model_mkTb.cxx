...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_INST_dut_DEF_CAN_FIRE_RL_count;
	 tUInt8 DEF_INST_top_INST_dut_DEF_WILL_FIRE_RL_count;
	 ...
	 DEF_INST_top_DEF_CAN_FIRE_RL_r2 = INST_top.INST_dut.METH_RDY_f2();
	 DEF_INST_top_DEF_WILL_FIRE_RL_r2 = DEF_INST_top_DEF_CAN_FIRE_RL_r2;
	 DEF_INST_top_INST_dut_DEF_CAN_FIRE_RL_count = (tUInt8)1u;
	 DEF_INST_top_INST_dut_DEF_WILL_FIRE_RL_count = DEF_INST_top_INST_dut_DEF_CAN_FIRE_RL_count;
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_r1)
	   INST_top.RL_r1();
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_r2)
	   INST_top.RL_r2();
	 if (DEF_INST_top_INST_dut_DEF_WILL_FIRE_RL_count)
	   INST_top.INST_dut.RL_count();
	 if (do_reset_ticks(simHdl))
	 {
	   INST_top.INST_dut.INST_x.rst_tick__clk__1((tUInt8)1u);
	 }
       };
...
time_t MODEL_mkTb::get_creation_time()
{
  ...
  /* Wed Dec 27 15:32:05 UTC 2023 */
  return 1703691125llu;
}
