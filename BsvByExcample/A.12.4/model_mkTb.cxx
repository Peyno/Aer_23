...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_up1;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_up1;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_up2;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_up2;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_up3;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_up3;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_done;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_done;
	 INST_top.DEF_b2___d16 = INST_top.INST_b2.METH_read();
	 DEF_INST_top_DEF_CAN_FIRE_RL_done = INST_top.DEF_b2___d16;
	 DEF_INST_top_DEF_WILL_FIRE_RL_done = DEF_INST_top_DEF_CAN_FIRE_RL_done;
	 DEF_INST_top_DEF_CAN_FIRE_RL_up1 = (tUInt8)1u;
	 DEF_INST_top_DEF_WILL_FIRE_RL_up1 = DEF_INST_top_DEF_CAN_FIRE_RL_up1;
	 DEF_INST_top_DEF_CAN_FIRE_RL_up2 = (tUInt8)1u;
	 DEF_INST_top_DEF_WILL_FIRE_RL_up2 = DEF_INST_top_DEF_CAN_FIRE_RL_up2 && !DEF_INST_top_DEF_WILL_FIRE_RL_up1;
	 DEF_INST_top_DEF_CAN_FIRE_RL_up3 = (tUInt8)1u;
	 DEF_INST_top_DEF_WILL_FIRE_RL_up3 = DEF_INST_top_DEF_CAN_FIRE_RL_up3;
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_up1)
	   INST_top.RL_up1();
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_done)
	   INST_top.RL_done();
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_up2)
	   INST_top.RL_up2();
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_up3)
	   INST_top.RL_up3();
	 if (do_reset_ticks(simHdl))
	 {
	   INST_top.INST_foo.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_foo2.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_b1.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_b2.rst_tick__clk__1((tUInt8)1u);
	 }
       };
...
time_t MODEL_mkTb::get_creation_time()
{
  ...
  /* Fri Jan 12 15:06:21 UTC 2024 */
  return 1705071981llu;
}
