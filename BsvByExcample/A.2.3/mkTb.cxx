 ...
 * 
 * On Tue Dec 26 16:04:37 CET 2023
 * 
 */
...
static std::string const __str_literal_8("All done", 8u);
static std::string const __str_literal_4("Second string = ", 16u);
static std::string const __str_literal_7("String passed t0 a function", 27u);
static std::string const __str_literal_3("This is a test", 14u);
static std::string const __str_literal_5("This is a test of concatenation", 31u);
static std::string const __str_literal_2("first string = ", 15u);
static std::string const __str_literal_6("passString => ", 14u);
...
{
  init_symbol(&symbols[0u], "b__h72", SYM_DEF, &DEF_b__h72, 32u);
...
void MOD_mkTb::RL_init()
{
  ...
  DEF_b__h72 = INST_step.METH_read();
  DEF_step_PLUS_1___d3 = DEF_b__h72 + 1u;
...
unsigned int MOD_mkTb::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_write_def(sim_hdl, num++, "b__h72", 32u);
...
void MOD_mkTb::vcd_defs(tVCDDumpType dt, MOD_mkTb &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.PORT_RST_N = PORT_RST_N;
      ...
      ++num;
      if ((backing.DEF_b__h72) != DEF_b__h72)
      {
	vcd_write_val(sim_hdl, num, DEF_b__h72, 32u);
	backing.DEF_b__h72 = DEF_b__h72;
      }
      ++num;
    }
    else
