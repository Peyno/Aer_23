...
static std::string const __str_literal_5("All done", 8u);
static std::string const __str_literal_4("i is ", 5u);
static std::string const __str_literal_2("isLarge = ", 10u);
...
{
  init_symbol(&symbols[0u], "b__h81", SYM_DEF, &DEF_b__h81, 32u);
...
{
  DEF_b__h81 = INST_step.METH_read();
  DEF_step_PLUS_1___d3 = DEF_b__h81 + 1u;
...
void MOD_mkTb::RL_step1()
{
  ...
  tUInt32 DEF_signed_2___d6;
  tUInt32 DEF_signed_4___d7;
  tUInt32 DEF_signed_8___d8;
  DEF_signed_8___d8 = 8u;
  DEF_signed_4___d7 = 4u;
  DEF_signed_2___d6 = 2u;
  ...
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    ...
    dollar_display(sim_hdl, this, "s,-32", &__str_literal_4, DEF_signed_1___d5);
    dollar_display(sim_hdl, this, "s,-32", &__str_literal_4, DEF_signed_2___d6);
    dollar_display(sim_hdl, this, "s,-32", &__str_literal_4, DEF_signed_4___d7);
    dollar_display(sim_hdl, this, "s,-32", &__str_literal_4, DEF_signed_8___d8);
  }
  INST_step.METH_write(DEF_step_PLUS_1___d3);
}
...
unsigned int MOD_mkTb::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_write_def(sim_hdl, num++, "b__h81", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
...
void MOD_mkTb::vcd_defs(tVCDDumpType dt, MOD_mkTb &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.PORT_RST_N = PORT_RST_N;
      ...
      ++num;
      if ((backing.DEF_b__h81) != DEF_b__h81)
      {
	vcd_write_val(sim_hdl, num, DEF_b__h81, 32u);
	backing.DEF_b__h81 = DEF_b__h81;
      }
      ++num;
