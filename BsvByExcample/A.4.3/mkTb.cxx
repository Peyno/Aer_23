...
void MOD_mkTb::RL_fill()
{
  ...
  INST_pipe.METH_send(DEF_b__h132);
  INST_x.METH_write(DEF_x_PLUS_0x10___d2);
}

void MOD_mkTb::RL_drain()
{
  tUInt8 DEF_NOT_pipe_receive_SLE_0x80___d6;
  tUInt32 DEF_b__h178;
  tUInt32 DEF_signed_pipe_receive___d4;
  DEF_b__h178 = INST_pipe.METH_receive();
  DEF_signed_pipe_receive___d4 = DEF_b__h178;
  DEF_NOT_pipe_receive_SLE_0x80___d6 = !primSLE8(1u, 32u, (tUInt32)(DEF_b__h178), 32u, 128u);
  dollar_display(sim_hdl, this, "s,-32", &__str_literal_1, DEF_signed_pipe_receive___d4);
  if (DEF_NOT_pipe_receive_SLE_0x80___d6)
