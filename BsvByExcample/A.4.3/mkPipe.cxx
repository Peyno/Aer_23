...
/* String declarations */
static std::string const __str_literal_1("  x1, x2, x3, x4 = %0h, %0h, %0h, %0h", 37u);
...
void MOD_mkPipe::METH_send(tUInt32 ARG_send_a)
{
  INST_x1.METH_write(ARG_send_a);
}
...
tUInt8 MOD_mkPipe::METH_RDY_receive()
{
  ...
  DEF_CAN_FIRE_receive = (tUInt8)1u;
