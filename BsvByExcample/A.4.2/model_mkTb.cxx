...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_r2a;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_r2a;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_r2b;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_r2b;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_show_and_eventually_stop;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_show_and_eventually_stop;
	 DEF_INST_top_DEF_CAN_FIRE_RL_r1 = (tUInt8)1u;
	 DEF_INST_top_DEF_WILL_FIRE_RL_r1 = DEF_INST_top_DEF_CAN_FIRE_RL_r1;
	 DEF_INST_top_DEF_CAN_FIRE_RL_r2a = (tUInt8)1u;
	 DEF_INST_top_DEF_WILL_FIRE_RL_r2a = DEF_INST_top_DEF_CAN_FIRE_RL_r2a;
	 DEF_INST_top_DEF_CAN_FIRE_RL_r2b = (tUInt8)1u;
	 DEF_INST_top_DEF_WILL_FIRE_RL_r2b = DEF_INST_top_DEF_CAN_FIRE_RL_r2b && !DEF_INST_top_DEF_WILL_FIRE_RL_r2a;
	 DEF_INST_top_DEF_CAN_FIRE_RL_show_and_eventually_stop = (tUInt8)1u;
	 DEF_INST_top_DEF_WILL_FIRE_RL_show_and_eventually_stop = DEF_INST_top_DEF_CAN_FIRE_RL_show_and_eventually_stop;
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_show_and_eventually_stop)
	   INST_top.RL_show_and_eventually_stop();
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_r1)
	   INST_top.RL_r1();
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_r2a)
	   INST_top.RL_r2a();
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_r2b)
	   INST_top.RL_r2b();
	 if (do_reset_ticks(simHdl))
	 {
	   INST_top.INST_x1.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_y1.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_x2.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_y2.rst_tick__clk__1((tUInt8)1u);
	 }
       };
...
time_t MODEL_mkTb::get_creation_time()
{
  ...
  /* Tue Dec 26 17:30:22 UTC 2023 */
  return 1703611822llu;
}
