 ...
 * 
 * On Wed Jan 10 11:32:24 CET 2024
 * 
 */
...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_INST_c2_DEF_CAN_FIRE_RL_doit;
	 tUInt8 DEF_INST_top_INST_c2_DEF_WILL_FIRE_RL_doit;
	 ...
	 DEF_INST_top_DEF_WILL_FIRE_RL_decr2 = DEF_INST_top_DEF_CAN_FIRE_RL_decr2 && !DEF_INST_top_DEF_WILL_FIRE_RL_incr2;
	 DEF_INST_top_DEF_CAN_FIRE_RL_show = (tUInt8)1u;
	 DEF_INST_top_DEF_WILL_FIRE_RL_show = DEF_INST_top_DEF_CAN_FIRE_RL_show;
	 DEF_INST_top_INST_c2_DEF_CAN_FIRE_RL_doit = (tUInt8)1u;
	 DEF_INST_top_INST_c2_DEF_WILL_FIRE_RL_doit = DEF_INST_top_INST_c2_DEF_CAN_FIRE_RL_doit;
	 ...
	 if (DEF_INST_top_INST_c2_DEF_WILL_FIRE_RL_doit)
	   INST_top.INST_c2.RL_doit();
	 INST_top.INST_c2.INST_rw_decr.clk((tUInt8)1u, (tUInt8)1u);
	 INST_top.INST_c2.INST_rw_incr.clk((tUInt8)1u, (tUInt8)1u);
...
void MODEL_mkTb::create_model(tSimStateHdl simHdl, bool master)
{
  ...
  (mkTb_instance->INST_c2.INST_rw_incr.set_clk_0)("CLK");
  (mkTb_instance->INST_c2.INST_rw_decr.set_clk_0)("CLK");
...
time_t MODEL_mkTb::get_creation_time()
{
  ...
  /* Wed Jan 10 10:32:24 UTC 2024 */
  return 1704882744llu;
}
