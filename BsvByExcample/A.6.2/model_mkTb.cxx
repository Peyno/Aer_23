...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_f_i_notFull____d5;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_step_state;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_step_state;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_enq1;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_enq1;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_enq2;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_enq2;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_deq;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_deq;
	 DEF_INST_top_DEF_CAN_FIRE_RL_deq = INST_top.INST_f.METH_i_notEmpty();
	 DEF_INST_top_DEF_WILL_FIRE_RL_deq = DEF_INST_top_DEF_CAN_FIRE_RL_deq;
	 INST_top.DEF_b__h189 = INST_top.INST_state.METH_read();
	 DEF_INST_top_DEF_f_i_notFull____d5 = INST_top.INST_f.METH_i_notFull();
	 DEF_INST_top_DEF_CAN_FIRE_RL_enq1 = DEF_INST_top_DEF_f_i_notFull____d5 && primSLT8(1u,
											    32u,
											    (tUInt32)(INST_top.DEF_b__h189),
											    32u,
											    7u);
	 DEF_INST_top_DEF_WILL_FIRE_RL_enq1 = DEF_INST_top_DEF_CAN_FIRE_RL_enq1;
	 DEF_INST_top_DEF_CAN_FIRE_RL_enq2 = DEF_INST_top_DEF_f_i_notFull____d5 && !primSLE8(1u,
											     32u,
											     (tUInt32)(INST_top.DEF_b__h189),
											     32u,
											     4u);
	 DEF_INST_top_DEF_WILL_FIRE_RL_enq2 = DEF_INST_top_DEF_CAN_FIRE_RL_enq2 && !DEF_INST_top_DEF_WILL_FIRE_RL_enq1;
	 ...
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_enq1)
	   INST_top.RL_enq1();
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_enq2)
	   INST_top.RL_enq2();
	 ...
	 {
	   INST_top.INST_f.rst_tick_clk((tUInt8)1u);
...
void MODEL_mkTb::create_model(tSimStateHdl simHdl, bool master)
{
  ...
  (mkTb_instance->INST_f.set_clk_0)("CLK");
...
time_t MODEL_mkTb::get_creation_time()
{
  ...
  /* Tue Jan  9 14:33:21 UTC 2024 */
  return 1704810801llu;
}
