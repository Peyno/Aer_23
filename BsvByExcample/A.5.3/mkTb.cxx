...
/* String declarations */
static std::string const __str_literal_1(" w = %0d", 8u);
...
void MOD_mkTb::RL_r1()
{
  tUInt8 DEF_NOT_dut_avmeth_SLE_50___d4;
  tUInt32 DEF_b__h81;
  tUInt32 DEF_signed_dut_avmeth___d2;
  tUInt32 DEF_AVMeth_dut_avmeth;
  DEF_AVMeth_dut_avmeth = INST_dut.METH_avmeth(10u);
  DEF_b__h81 = DEF_AVMeth_dut_avmeth;
  DEF_signed_dut_avmeth___d2 = DEF_b__h81;
  DEF_NOT_dut_avmeth_SLE_50___d4 = !primSLE8(1u, 32u, (tUInt32)(DEF_b__h81), 32u, 50u);
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    dollar_display(sim_hdl, this, "s,-32", &__str_literal_1, DEF_signed_dut_avmeth___d2);
    if (DEF_NOT_dut_avmeth_SLE_50___d4)
