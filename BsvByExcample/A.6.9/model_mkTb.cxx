...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_rA;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_rA;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_rB;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_rB;
	 ...
	 DEF_INST_top_DEF_CAN_FIRE_RL_rA = INST_top.INST_f1.METH_i_notFull() && INST_top.INST_f0.METH_i_notFull();
	 DEF_INST_top_DEF_WILL_FIRE_RL_rA = DEF_INST_top_DEF_CAN_FIRE_RL_rA;
	 DEF_INST_top_DEF_CAN_FIRE_RL_rB = INST_top.INST_f0.METH_i_notEmpty();
	 DEF_INST_top_DEF_WILL_FIRE_RL_rB = DEF_INST_top_DEF_CAN_FIRE_RL_rB;
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_rA)
	   INST_top.RL_rA();
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_count_cycles)
	   INST_top.RL_count_cycles();
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_rB)
	   INST_top.RL_rB();
	 if (do_reset_ticks(simHdl))
	 {
	   INST_top.INST_cycle.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_f0.rst_tick_clk((tUInt8)1u);
	   INST_top.INST_f1.rst_tick_clk((tUInt8)1u);
	 }
       };
...
void MODEL_mkTb::create_model(tSimStateHdl simHdl, bool master)
{
  ...
  (mkTb_instance->INST_f0.set_clk_0)("CLK");
  (mkTb_instance->INST_f1.set_clk_0)("CLK");
...
time_t MODEL_mkTb::get_creation_time()
{
  ...
  /* Tue Jan  9 16:24:09 UTC 2024 */
  return 1704817449llu;
}
