...
class MOD_mkTB : public Module {
 ...
 public:
  ...
  MOD_Fifo<tUInt32> INST_dut_in;
  MOD_Fifo<tUInt32> INST_dut_out;
 ...
 public:
  tUInt8 DEF_WILL_FIRE_RL_action_l29c1;
  tUInt8 DEF_WILL_FIRE_RL_action_l27c12;
 ...
 public:
  ...
  void RL_state_every();
  void RL_restart();
  void RL_action_l27c12();
  void RL_action_l29c1();
  void RL_idle_l26c14();
  void RL_fsm_start();
  void RL_auto_start();
  void RL_auto_finish();
