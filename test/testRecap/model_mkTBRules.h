...
/* Generation options: */
#ifndef __model_mkTBRules_h__
#define __model_mkTBRules_h__
...
/* Class declaration for a model of mkTBRules */
class MODEL_mkTBRules : public Model {
 
 /* Top-level module instance */
 private:
  MOD_mkTBRules *mkTBRules_instance;
...
#endif /* ifndef __model_mkTBRules_h__ */
