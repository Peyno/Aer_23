...
static std::string const __str_literal_2("Error: \"Tb.bsv\", line 77, column 16: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l77c16] and\n  [RL_action_l79c1] ) fired in the same clock cycle.\n",
					 166u);
...
MOD_mkTb::MOD_mkTb(tSimStateHdl simHdl, char const *name, Module *parent)
  : Module(simHdl, name, parent),
    ...
    INST_uut_test(simHdl, "uut_test", this, 32u, 0u, (tUInt8)0u),
    INST_uut_value(simHdl, "uut_value", this, 32u, 0u, (tUInt8)0u),
...
void MOD_mkTb::init_symbols_0()
{
  ...
  init_symbol(&symbols[3u], "RL_action_l77c16", SYM_RULE);
  init_symbol(&symbols[4u], "RL_action_l79c1", SYM_RULE);
  ...
  init_symbol(&symbols[8u], "RL_idle_l75c9", SYM_RULE);
  ...
  init_symbol(&symbols[14u], "RL_uut_r1", SYM_RULE);
  init_symbol(&symbols[15u], "RL_uut_r2", SYM_RULE);
  ...
  init_symbol(&symbols[27u], "uut_in", SYM_MODULE, &INST_uut_in);
  init_symbol(&symbols[28u], "uut_out", SYM_MODULE, &INST_uut_out);
  init_symbol(&symbols[29u], "uut_test", SYM_MODULE, &INST_uut_test);
  init_symbol(&symbols[30u], "uut_value", SYM_MODULE, &INST_uut_value);
  init_symbol(&symbols[31u],
	      "WILL_FIRE_RL_action_l77c16",
	      SYM_DEF,
	      &DEF_WILL_FIRE_RL_action_l77c16,
	      1u);
  init_symbol(&symbols[32u],
	      "WILL_FIRE_RL_action_l79c1",
	      SYM_DEF,
	      &DEF_WILL_FIRE_RL_action_l79c1,
	      1u);
}
...
void MOD_mkTb::RL_uut_r1()
{
  tUInt32 DEF_uut_in_first____d2;
  DEF_uut_in_first____d2 = INST_uut_in.METH_first();
  INST_uut_in.METH_deq();
  INST_uut_test.METH_write(DEF_uut_in_first____d2);
}

void MOD_mkTb::RL_uut_r2()
{
  tUInt32 DEF_b__h505;
  DEF_b__h505 = INST_uut_test.METH_read();
  INST_uut_out.METH_enq(DEF_b__h505);
}
...
void MOD_mkTb::RL_state_every()
{
  ...
  tUInt8 DEF_state_can_overlap__h1887;
  DEF_state_can_overlap__h1887 = INST_state_can_overlap.METH_read();
  DEF_state_set_pw_whas__0_OR_NOT_state_overlap_pw_w_ETC___d25 = INST_state_set_pw.METH_whas() || (!INST_state_overlap_pw.METH_whas() && DEF_state_can_overlap__h1887);
...
void MOD_mkTb::RL_action_l77c16()
{
  tUInt32 DEF_b__h7324;
  DEF_b__h7324 = INST_a.METH_read();
  INST_state_mkFSMstate.METH_write((tUInt8)1u);
  INST_state_fired_1.METH_wset((tUInt8)1u);
  INST_state_set_pw.METH_wset();
  INST_uut_in.METH_enq(DEF_b__h7324);
}

void MOD_mkTb::RL_action_l79c1()
{
  tUInt32 DEF_signed_uut_out_first__8___d49;
  DEF_signed_uut_out_first__8___d49 = INST_uut_out.METH_first();
  INST_state_mkFSMstate.METH_write((tUInt8)2u);
  INST_state_fired_1.METH_wset((tUInt8)1u);
  INST_state_set_pw.METH_wset();
  if (!(PORT_RST_N == (tUInt8)0u))
    dollar_display(sim_hdl, this, "s,-32", &__str_literal_1, DEF_signed_uut_out_first__8___d49);
  INST_uut_out.METH_deq();
}

void MOD_mkTb::RL_idle_l75c9()
{
  INST_state_mkFSMstate.METH_write((tUInt8)0u);
  INST_state_fired_1.METH_wset((tUInt8)1u);
  INST_state_set_pw.METH_wset();
...
{
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_WILL_FIRE_RL_action_l77c16 && DEF_WILL_FIRE_RL_action_l79c1)
...
void MOD_mkTb::reset_RST_N(tUInt8 ARG_rst_in)
{
  ...
  INST_uut_value.reset_RST(ARG_rst_in);
  INST_uut_test.reset_RST(ARG_rst_in);
...
void MOD_mkTb::dump_state(unsigned int indent)
{
  ...
  INST_uut_test.dump_state(indent + 2u);
  INST_uut_value.dump_state(indent + 2u);
}
...
unsigned int MOD_mkTb::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_action_l77c16", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_action_l79c1", 1u);
  ...
  num = INST_uut_test.dump_VCD_defs(num);
  num = INST_uut_value.dump_VCD_defs(num);
...
void MOD_mkTb::vcd_defs(tVCDDumpType dt, MOD_mkTb &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.PORT_RST_N = PORT_RST_N;
      ...
      ++num;
      if ((backing.DEF_WILL_FIRE_RL_action_l77c16) != DEF_WILL_FIRE_RL_action_l77c16)
      {
	vcd_write_val(sim_hdl, num, DEF_WILL_FIRE_RL_action_l77c16, 1u);
	backing.DEF_WILL_FIRE_RL_action_l77c16 = DEF_WILL_FIRE_RL_action_l77c16;
      }
      ++num;
      if ((backing.DEF_WILL_FIRE_RL_action_l79c1) != DEF_WILL_FIRE_RL_action_l79c1)
      {
	vcd_write_val(sim_hdl, num, DEF_WILL_FIRE_RL_action_l79c1, 1u);
	backing.DEF_WILL_FIRE_RL_action_l79c1 = DEF_WILL_FIRE_RL_action_l79c1;
      }
      ++num;
    }
    else
...
void MOD_mkTb::vcd_prims(tVCDDumpType dt, MOD_mkTb &backing)
{
  ...
  INST_uut_test.dump_VCD(dt, backing.INST_uut_test);
  INST_uut_value.dump_VCD(dt, backing.INST_uut_value);
}
