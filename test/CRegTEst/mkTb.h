...
class MOD_mkTb : public Module {
 ...
 public:
  ...
  MOD_Fifo<tUInt32> INST_uut_in;
  MOD_Fifo<tUInt32> INST_uut_out;
  MOD_Reg<tUInt32> INST_uut_test;
  MOD_CReg<tUInt32> INST_uut_value;
 ...
 public:
  tUInt8 DEF_WILL_FIRE_RL_action_l79c1;
  tUInt8 DEF_WILL_FIRE_RL_action_l77c16;
 ...
 public:
  ...
  void RL_state_every();
  void RL_restart();
  void RL_action_l77c16();
  void RL_action_l79c1();
  void RL_idle_l75c9();
  void RL_fsm_start();
  void RL_auto_start();
  void RL_auto_finish();
