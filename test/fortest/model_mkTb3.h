...
/* Generation options: */
#ifndef __model_mkTb3_h__
#define __model_mkTb3_h__
...
/* Class declaration for a model of mkTb3 */
class MODEL_mkTb3 : public Model {
 
 /* Top-level module instance */
 private:
  MOD_mkTb3 *mkTb3_instance;
...
#endif /* ifndef __model_mkTb3_h__ */
