...
/* Generation options: */
#ifndef __model_mkPipeline_h__
#define __model_mkPipeline_h__
...
/* Class declaration for a model of mkPipeline */
class MODEL_mkPipeline : public Model {
 
 /* Top-level module instance */
 private:
  MOD_mkPipeline *mkPipeline_instance;
...
#endif /* ifndef __model_mkPipeline_h__ */
