...
/* Generation options: */
#ifndef __model_mkMacTb_h__
#define __model_mkMacTb_h__
...
/* Class declaration for a model of mkMacTb */
class MODEL_mkMacTb : public Model {
 
 /* Top-level module instance */
 private:
  MOD_mkMacTb *mkMacTb_instance;
...
#endif /* ifndef __model_mkMacTb_h__ */
