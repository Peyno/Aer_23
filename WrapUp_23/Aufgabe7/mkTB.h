...
class MOD_mkTB : public Module {
 ...
 public:
  ...
  MOD_Reg<tUInt32> INST_dut_params_0;
  MOD_Reg<tUInt32> INST_dut_params_1;
  MOD_Reg<tUInt32> INST_dut_params_2;
  MOD_Reg<tUInt32> INST_dut_params_3;
 ...
 public:
  tUInt8 DEF_WILL_FIRE_RL_action_l257c9;
  tUInt8 DEF_WILL_FIRE_RL_action_l256c1;
  tUInt8 DEF_WILL_FIRE_RL_action_l255c12;
  tUInt8 DEF_WILL_FIRE_RL_dut_fsm_action_l153c13;
  tUInt8 DEF_WILL_FIRE_RL_dut_fsm_action_l148c9;
  tUInt8 DEF_WILL_FIRE_RL_dut_fsm_action_l144c9;
  tUInt8 DEF_WILL_FIRE_RL_dut_fsm_action_l140c9;
  tUInt8 DEF_WILL_FIRE_RL_dut_fsm_action_l136c9;
  tUInt8 DEF_WILL_FIRE_RL_dut_fsm_action_l132c9;
  tUInt8 DEF_WILL_FIRE_RL_dut_fsm_action_l128c9;
  tUInt8 DEF_WILL_FIRE_RL_dut_fsm_action_l119c9;
 
 /* Local definitions */
 private:
  tUWide DEF_dut_incoming_first____d59;
  tUInt32 DEF_dut_adder_out_first____d75;
 ...
 public:
  ...
  void RL_dut_fsm_action_l119c9();
  void RL_dut_fsm_action_l128c9();
  void RL_dut_fsm_action_l132c9();
  void RL_dut_fsm_action_l136c9();
  void RL_dut_fsm_action_l140c9();
  void RL_dut_fsm_action_l144c9();
  void RL_dut_fsm_action_l148c9();
  void RL_dut_fsm_action_l153c13();
  void RL_dut_fsm_idle_l118c14();
  ...
  void RL_state_every();
  void RL_restart();
  void RL_action_l255c12();
  void RL_action_l256c1();
  void RL_action_l257c9();
  void RL_idle_l253c17();
  void RL_fsm_start();
  void RL_auto_start();
  void RL_auto_finish();
  void __me_check_8();
