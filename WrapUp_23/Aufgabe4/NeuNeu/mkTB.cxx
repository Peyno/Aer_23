...
static std::string const __str_literal_2("Error: \"Tb.bsv\", line 38, column 23: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_f_init_l38c13] and\n  [RL_action_l39c18, RL_action_l40c17, RL_action_f_update_l38c13] ) fired in\n  the same clock cycle.\n",
					 221u);
static std::string const __str_literal_3("Error: \"Tb.bsv\", line 39, column 18: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l39c18] and\n  [RL_action_l40c17, RL_action_f_update_l38c13] ) fired in the same clock\n  cycle.\n",
					 196u);
static std::string const __str_literal_4("Error: \"Tb.bsv\", line 40, column 17: (R0001)\n  Mutually exclusive rules (from the ME sets [RL_action_l40c17] and\n  [RL_action_f_update_l38c13] ) fired in the same clock cycle.\n",
					 176u);
...
MOD_mkTB::MOD_mkTB(tSimStateHdl simHdl, char const *name, Module *parent)
  : Module(simHdl, name, parent),
    ...
    DEF_s_stack__h14687(160u),
    DEF_IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d72(160u),
    DEF_IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d65(96u)
{
  symbol_count = 38u;
...
void MOD_mkTB::init_symbols_0()
{
  ...
  init_symbol(&symbols[6u], "RL_action_f_init_l38c13", SYM_RULE);
  init_symbol(&symbols[7u], "RL_action_f_update_l38c13", SYM_RULE);
  init_symbol(&symbols[8u], "RL_action_l39c18", SYM_RULE);
  init_symbol(&symbols[9u], "RL_action_l40c17", SYM_RULE);
  ...
  init_symbol(&symbols[13u], "RL_idle_l38c13", SYM_RULE);
  init_symbol(&symbols[14u], "RL_idle_l38c13_1", SYM_RULE);
  init_symbol(&symbols[15u], "RL_restart", SYM_RULE);
  init_symbol(&symbols[16u], "RL_start_reg__dreg_update", SYM_RULE);
  init_symbol(&symbols[17u], "RL_state_every", SYM_RULE);
  init_symbol(&symbols[18u], "RL_state_fired__dreg_update", SYM_RULE);
  init_symbol(&symbols[19u], "RL_state_handle_abort", SYM_RULE);
  init_symbol(&symbols[20u], "running", SYM_MODULE, &INST_running);
  init_symbol(&symbols[21u], "s_index", SYM_MODULE, &INST_s_index);
  init_symbol(&symbols[22u], "s_stack", SYM_MODULE, &INST_s_stack);
  ...
  init_symbol(&symbols[33u],
	      "WILL_FIRE_RL_action_f_init_l38c13",
	      SYM_DEF,
	      &DEF_WILL_FIRE_RL_action_f_init_l38c13,
	      1u);
  init_symbol(&symbols[34u],
	      "WILL_FIRE_RL_action_f_update_l38c13",
	      SYM_DEF,
	      &DEF_WILL_FIRE_RL_action_f_update_l38c13,
	      1u);
  init_symbol(&symbols[35u],
	      "WILL_FIRE_RL_action_l39c18",
	      SYM_DEF,
	      &DEF_WILL_FIRE_RL_action_l39c18,
	      1u);
  init_symbol(&symbols[36u],
	      "WILL_FIRE_RL_action_l40c17",
	      SYM_DEF,
	      &DEF_WILL_FIRE_RL_action_l40c17,
	      1u);
...
void MOD_mkTB::RL_action_f_init_l38c13()
{
  INST_state_mkFSMstate.METH_write((tUInt8)1u);
  INST_state_fired_1.METH_wset((tUInt8)1u);
  INST_state_set_pw.METH_wset();
  INST_count.METH_write(0u);
}

void MOD_mkTB::RL_action_l39c18()
{
  tUInt32 DEF_s_index_9_PLUS_1___d73;
  DEF_x__h14401 = INST_s_index.METH_read();
  DEF_s_stack__h14687 = INST_s_stack.METH_read();
  DEF_b__h5484 = INST_count.METH_read();
  DEF_v__h14332 = DEF_s_stack__h14687.get_whole_word(4u);
  DEF_v__h14327 = DEF_s_stack__h14687.get_whole_word(3u);
  DEF_v__h14322 = DEF_s_stack__h14687.get_whole_word(2u);
  DEF_v__h14317 = DEF_s_stack__h14687.get_whole_word(1u);
  DEF_v__h14312 = DEF_s_stack__h14687.get_whole_word(0u);
  DEF_IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d65.set_whole_word(DEF_x__h14401 == 4u ? DEF_b__h5484 : DEF_v__h14332,
									      2u).set_whole_word(DEF_x__h14401 == 3u ? DEF_b__h5484 : DEF_v__h14327,
												 1u).set_whole_word(DEF_x__h14401 == 2u ? DEF_b__h5484 : DEF_v__h14322,
														    0u);
  DEF_IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d72.set_whole_word(DEF_IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d65.get_whole_word(2u),
									      4u).set_whole_word(DEF_IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d65.get_whole_word(1u),
												 3u).build_concat(bs_wide_tmp(96u).set_whole_word(DEF_IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d65.get_whole_word(0u),
														  ...
														  0u,
														  96u);
  DEF_s_index_9_PLUS_1___d73 = DEF_x__h14401 + 1u;
  INST_state_mkFSMstate.METH_write((tUInt8)2u);
  INST_state_fired_1.METH_wset((tUInt8)1u);
  INST_state_set_pw.METH_wset();
  INST_s_stack.METH_write(DEF_IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d72);
  INST_s_index.METH_write(DEF_s_index_9_PLUS_1___d73);
}

void MOD_mkTB::RL_action_l40c17()
{
  tUInt32 DEF_SEL_ARR_s_stack_6_BITS_31_TO_0_0_s_stack_6_BIT_ETC___d81;
  tUInt32 DEF_signed_SEL_ARR_s_stack_6_BITS_31_TO_0_0_s_sta_ETC___d82;
  ...
  case 0u:
    DEF_SEL_ARR_s_stack_6_BITS_31_TO_0_0_s_stack_6_BIT_ETC___d81 = DEF_v__h14312;
    break;
  case 1u:
    DEF_SEL_ARR_s_stack_6_BITS_31_TO_0_0_s_stack_6_BIT_ETC___d81 = DEF_v__h14317;
    break;
  case 2u:
    DEF_SEL_ARR_s_stack_6_BITS_31_TO_0_0_s_stack_6_BIT_ETC___d81 = DEF_v__h14322;
    break;
  case 3u:
    DEF_SEL_ARR_s_stack_6_BITS_31_TO_0_0_s_stack_6_BIT_ETC___d81 = DEF_v__h14327;
    break;
  case 4u:
    DEF_SEL_ARR_s_stack_6_BITS_31_TO_0_0_s_stack_6_BIT_ETC___d81 = DEF_v__h14332;
    break;
  default:
    DEF_SEL_ARR_s_stack_6_BITS_31_TO_0_0_s_stack_6_BIT_ETC___d81 = 2863311530u;
  }
  DEF_signed_SEL_ARR_s_stack_6_BITS_31_TO_0_0_s_sta_ETC___d82 = DEF_SEL_ARR_s_stack_6_BITS_31_TO_0_0_s_stack_6_BIT_ETC___d81;
  ...
  if (!(PORT_RST_N == (tUInt8)0u))
    dollar_display(sim_hdl,
		   ...
		   "s,-32",
		   &__str_literal_1,
		   DEF_signed_SEL_ARR_s_stack_6_BITS_31_TO_0_0_s_sta_ETC___d82);
}

void MOD_mkTB::RL_action_f_update_l38c13()
{
  tUInt32 DEF_count_6_PLUS_1___d85;
  DEF_b__h5484 = INST_count.METH_read();
  DEF_count_6_PLUS_1___d85 = DEF_b__h5484 + 1u;
  INST_state_mkFSMstate.METH_write((tUInt8)4u);
  INST_state_fired_1.METH_wset((tUInt8)1u);
  INST_state_set_pw.METH_wset();
  INST_count.METH_write(DEF_count_6_PLUS_1___d85);
}

void MOD_mkTB::RL_idle_l38c13()
{
  INST_state_mkFSMstate.METH_write((tUInt8)0u);
  INST_state_fired_1.METH_wset((tUInt8)1u);
  INST_state_set_pw.METH_wset();
...
void MOD_mkTB::RL_idle_l38c13_1()
{
  INST_state_mkFSMstate.METH_write((tUInt8)0u);
  INST_state_fired_1.METH_wset((tUInt8)1u);
  INST_state_set_pw.METH_wset();
...
{
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_WILL_FIRE_RL_action_f_init_l38c13 && ((DEF_WILL_FIRE_RL_action_l39c18 || DEF_WILL_FIRE_RL_action_l40c17) || DEF_WILL_FIRE_RL_action_f_update_l38c13))
...
{
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_WILL_FIRE_RL_action_l39c18 && (DEF_WILL_FIRE_RL_action_l40c17 || DEF_WILL_FIRE_RL_action_f_update_l38c13))
...
{
  if (!(PORT_RST_N == (tUInt8)0u))
    if (DEF_WILL_FIRE_RL_action_l40c17 && DEF_WILL_FIRE_RL_action_f_update_l38c13)
...
unsigned int MOD_mkTB::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_write_def(sim_hdl, num++, "IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d65", 96u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d72", 160u);
  vcd_write_def(sim_hdl, num++, "RST_N", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_action_f_init_l38c13", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_action_f_update_l38c13", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_action_l39c18", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "WILL_FIRE_RL_action_l40c17", 1u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "b__h5484", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "s_stack__h14687", 160u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
...
void MOD_mkTB::vcd_defs(tVCDDumpType dt, MOD_mkTB &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
    ...
    {
      if ((backing.DEF_IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d65) != DEF_IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d65)
      {
	vcd_write_val(sim_hdl, num, DEF_IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d65, 96u);
	backing.DEF_IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d65 = DEF_IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d65;
      }
      ++num;
      if ((backing.DEF_IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d72) != DEF_IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d72)
      {
	vcd_write_val(sim_hdl, num, DEF_IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d72, 160u);
	backing.DEF_IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d72 = DEF_IF_s_index_9_EQ_4_5_THEN_count_6_ELSE_s_stack__ETC___d72;
      }
      ++num;
	...
	backing.PORT_RST_N = PORT_RST_N;
      ...
      ++num;
      if ((backing.DEF_WILL_FIRE_RL_action_f_init_l38c13) != DEF_WILL_FIRE_RL_action_f_init_l38c13)
      {
	vcd_write_val(sim_hdl, num, DEF_WILL_FIRE_RL_action_f_init_l38c13, 1u);
	backing.DEF_WILL_FIRE_RL_action_f_init_l38c13 = DEF_WILL_FIRE_RL_action_f_init_l38c13;
      }
      ++num;
      if ((backing.DEF_WILL_FIRE_RL_action_f_update_l38c13) != DEF_WILL_FIRE_RL_action_f_update_l38c13)
      {
	vcd_write_val(sim_hdl, num, DEF_WILL_FIRE_RL_action_f_update_l38c13, 1u);
	backing.DEF_WILL_FIRE_RL_action_f_update_l38c13 = DEF_WILL_FIRE_RL_action_f_update_l38c13;
      }
      ++num;
      if ((backing.DEF_WILL_FIRE_RL_action_l39c18) != DEF_WILL_FIRE_RL_action_l39c18)
      {
	vcd_write_val(sim_hdl, num, DEF_WILL_FIRE_RL_action_l39c18, 1u);
	backing.DEF_WILL_FIRE_RL_action_l39c18 = DEF_WILL_FIRE_RL_action_l39c18;
      }
      ++num;
      if ((backing.DEF_WILL_FIRE_RL_action_l40c17) != DEF_WILL_FIRE_RL_action_l40c17)
      {
	vcd_write_val(sim_hdl, num, DEF_WILL_FIRE_RL_action_l40c17, 1u);
	backing.DEF_WILL_FIRE_RL_action_l40c17 = DEF_WILL_FIRE_RL_action_l40c17;
      }
      ++num;
	...
	backing.DEF_b__h5484 = DEF_b__h5484;
      ...
      ++num;
      if ((backing.DEF_s_stack__h14687) != DEF_s_stack__h14687)
      {
	vcd_write_val(sim_hdl, num, DEF_s_stack__h14687, 160u);
	backing.DEF_s_stack__h14687 = DEF_s_stack__h14687;
      }
      ++num;
