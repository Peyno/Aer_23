...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_push;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_push;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_peek;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_peek;
	 tUInt8 DEF_INST_top_DEF_CAN_FIRE_RL_finish;
	 tUInt8 DEF_INST_top_DEF_WILL_FIRE_RL_finish;
	 INST_top.DEF_b__h175 = INST_top.INST_wert.METH_read();
	 DEF_INST_top_DEF_CAN_FIRE_RL_finish = !primSLE8(1u, 32u, (tUInt32)(INST_top.DEF_b__h175), 32u, 4u);
	 DEF_INST_top_DEF_WILL_FIRE_RL_finish = DEF_INST_top_DEF_CAN_FIRE_RL_finish;
	 INST_top.DEF_x__h611 = INST_top.INST_s_index.METH_read();
	 DEF_INST_top_DEF_CAN_FIRE_RL_peek = !primSLE8(1u, 32u, (tUInt32)(INST_top.DEF_x__h611), 32u, 0u);
	 DEF_INST_top_DEF_WILL_FIRE_RL_peek = DEF_INST_top_DEF_CAN_FIRE_RL_peek;
	 DEF_INST_top_DEF_CAN_FIRE_RL_push = primSLT8(1u, 32u, (tUInt32)(INST_top.DEF_x__h611), 32u, 5u);
	 DEF_INST_top_DEF_WILL_FIRE_RL_push = DEF_INST_top_DEF_CAN_FIRE_RL_push;
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_peek)
	   INST_top.RL_peek();
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_finish)
	   INST_top.RL_finish();
	 if (DEF_INST_top_DEF_WILL_FIRE_RL_push)
	   INST_top.RL_push();
	 if (do_reset_ticks(simHdl))
	 {
	   INST_top.INST_s_index.rst_tick__clk__1((tUInt8)1u);
	   INST_top.INST_wert.rst_tick__clk__1((tUInt8)1u);
	 }
       };
...
time_t MODEL_mkTb::get_creation_time()
{
  ...
  /* Thu Feb  8 21:08:39 UTC 2024 */
  return 1707426519llu;
}
