...
/* Generation options: */
#ifndef __model_mkAmpelTest_h__
#define __model_mkAmpelTest_h__
...
/* Class declaration for a model of mkAmpelTest */
class MODEL_mkAmpelTest : public Model {
 
 /* Top-level module instance */
 private:
  MOD_mkAmpelTest *mkAmpelTest_instance;
...
#endif /* ifndef __model_mkAmpelTest_h__ */
